  ...
  config.services.autorandr = {
    ...
    profiles =
      let
        ...
        lg = "";
      ...
      in
      {
        ...
        philips-hdmi-laptop-closed-usbc-1st-port = make-only-laptop-closed "DP-3" philipsHdmi "2560x1440";
        philips-hdmi-laptop-closed-usbc-2nd-port = make-only-laptop-closed "DP-2" philipsHdmi "2560x1440";
        philips-usbc-laptop-closed-usbc-1st-port = make-only-laptop-closed "DP-3-8" philipsUsbC "2560x1440";
        philips-usbc-laptop-closed-usbc-2nd-port = make-only-laptop-closed "DP-2-8" philipsUsbC "2560x1440";
        philips-hdmi-laptop-open-usbc-1st-port = make-only-laptop-open "DP-3" philipsHdmi "2560x1440";
        philips-hdmi-laptop-open-usbc-2nd-port = make-only-laptop-open "DP-2" philipsHdmi "2560x1440";
        philips-usbc-laptop-open-usbc-1st-port = make-only-laptop-open "DP-3-8" philipsUsbC "2560x1440";
        philips-usbc-laptop-open-usbc-2nd-port = make-only-laptop-open "DP-2-8" philipsUsbC "2560x1440";
